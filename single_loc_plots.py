...
def plot_figure_5a(hours, v_ceiling, optimal_heights, ceiling_height, floor_height):
...
def plot_figure_5b(hours, v_levels, level_heights, v_ceiling, optimal_heights, ceiling_height, floor_height):
...
def main():
    ...
    plot_figure_5a(hours, v_ceilings[:, 1], optimal_heights[:, 1],
                   analyzed_heights['ceilings'][1], analyzed_heights['floor'])
